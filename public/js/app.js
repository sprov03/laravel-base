...
},{"decode-uri-component":26,"object-assign":31,"strict-uri-encode":32}],31:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
var UPDATE = exports.UPDATE = function UPDATE(state, _ref) {
    var module = _ref.module,
        resource = _ref.resource,
        field = _ref.field,
        value = _ref.value,
        resourceData = _ref.resourceData,
    ...
    if (state[module][resource] === undefined) {
        _vue2.default.log.debug('setting resource');
        _vue2.default.set(state[module], resource, resourceData || {});
    }
    /**
     * Passing resourceData overrides everything sets the resource and returns.
     */
    if (resourceData) {
        _vue2.default.log.debug('setting resource default');
    ...
    if (field && state[module][resource][field] === undefined) {
        _vue2.default.log.debug('setting field and default');
        _vue2.default.set(state[module][resource], field, defaultValue);
    }
...
var UPDATE_LOOKUP_FIELD = exports.UPDATE_LOOKUP_FIELD = function UPDATE_LOOKUP_FIELD(state, _ref10) {
    ...
    if (reference && reference[field]) {
        _vue2.default.log.debug('setting lookup value:' + value + ' on:' + field + ' at:' + path);
...
var ADD_STATUS = exports.ADD_STATUS = function ADD_STATUS(state, resource) {
...
var SET_PAGE_MESSAGE = exports.SET_PAGE_MESSAGE = function SET_PAGE_MESSAGE(state, message) {
    _vue2.default.log.debug('set page message');
...
var ADD_ALERT = exports.ADD_ALERT = function ADD_ALERT(state, alert) {
    state.alerts.push(alert);
};

var ADD_MODAL = exports.ADD_MODAL = function ADD_MODAL(state, modal) {
    state.modal = modal;
};

var READ_URL_PARAMETERS = exports.READ_URL_PARAMETERS = function READ_URL_PARAMETERS(state) {
    state.url.search = _queryString2.default.parse(location.search);
